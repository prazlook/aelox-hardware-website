    ...
    <div className="min-h-[calc(100vh-120px)] flex flex-col items-center justify-center text-center p-4 sm:p-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-slide-up" style={{ animationDelay: '0.6s' }}>
        <div className="relative">
          ...
          <Button 
            asChild 
            className="bg-theme-cyan text-black hover:bg-theme-cyan/90 px-8 py-6 text-lg rounded-xl shadow-lg relative z-10 overflow-visible"
            onMouseEnter={() => setIsHovered(true)}
            onMouseLeave={() => setIsHovered(false)}
          >
            <Link to="/dashboard" className={cn("flex items-center justify-center animate-button-build")} style={{ animationDelay: '0.8s' }}>
